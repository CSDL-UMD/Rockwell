...
MAX = 100
universal_buffer = []
accessPool = Pool.Pool(MIN,MAX) # Maybe make 2 pools and half the functions use each or make this one huge.
app = Flask(__name__)
...
@app.route('/insert_tweet/', methods=['GET'])
def insert_tweet(tweet_id):
    try:
